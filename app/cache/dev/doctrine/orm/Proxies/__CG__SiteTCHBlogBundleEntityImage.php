...
namespace Proxies\__CG__\SiteTCH\BlogBundle\Entity;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class Image extends \SiteTCH\BlogBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setNomfichiertemporaire($nomfichiertemporaire);
    }

    public function getNomfichiertemporaire()
    {
        $this->__load();
        return parent::getNomfichiertemporaire();
    }

    public function getCheminImage()
    {
        $this->__load();
        return parent::getCheminImage();
    }
